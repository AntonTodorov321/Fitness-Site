        ...
        private ApplicationUser[] GenerateUsers()
        {
            List<ApplicationUser> users = new List<ApplicationUser>()
            {
                new ApplicationUser()
                {
                    ...
                    PasswordHash =
                        "AQAAAAEAACcQAAAAEPkFrXPoUKAiePrdfD7MpV8GM3DDLiGHeL0t59CRhINfNeFNYk5KsFBtvu4333byRQ==",
                ...
                new ApplicationUser()
                {
                    ...
                    EmailConfirmed = false,
                    PasswordHash =
                        "AQAAAAEAACcQAAAAED2g4IMnJy5+pVB/Al2nlBK2s6EfebghA0LGqA+e1qJ45j9COBwKW9gIxV6jhrmKvw==",
