...
namespace FitnessSite.Data.Migrations
{
    ...
    [Migration("20230705150223_AddNullableFKToUserTrainerId")]
    partial class AddNullableFKToUserTrainerId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitnessSite.Data.Models.TypeWeight", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitnessSite.Data.Models.Exercise", b =>
                {
                    ...
                    b.HasOne("FitnessSite.Data.Models.TypeWeight", "TypeWeight")
                        .WithMany("Exercises")
                        .HasForeignKey("TypeWeightId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Type");

                    b.Navigation("TypeWeight");
                });
